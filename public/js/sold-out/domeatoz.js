...
(async () => {
    ...
    try {
        ...
        await page.waitForNavigation({ waitUntil: 'networkidle2' });
        await page.waitForSelector('#list > tr:nth-child(1) > td.text-center.align-middle.p-1 > input', { visible: true });
        await page.select('#stateChange', '2');
        await page.click('#list > tr:nth-child(1) > td.text-center.align-middle.p-1 > input');
