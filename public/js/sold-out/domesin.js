...
try {
    ...
    // Navigate to login page with no timeout
    await page.goto('https://www.domesin.com/scm/login.html', { timeout: 0 });

    // Wait for input fields and sign in button
    const usernameInputSelector = 'body > table > tbody > tr:nth-child(1) > td > table > tbody > tr > td > table > tbody > tr > td:nth-child(1) > table > tbody > tr:nth-child(1) > td > input';
    const passwordInputSelector = 'body > table > tbody > tr:nth-child(1) > td > table > tbody > tr > td > table > tbody > tr > td:nth-child(1) > table > tbody > tr:nth-child(3) > td > input';
    const signInBtnSelector = 'body > table > tbody > tr:nth-child(1) > td > table > tbody > tr > td > table > tbody > tr > td:nth-child(3) > input[type=image]';
    ...
    // Wait for navigation after sign in with no timeout
