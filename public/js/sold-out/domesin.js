...
async function processDelProduct(page, browser, productCode) {
    const searchProductCodeUrl = 'http://www.domesin.com/scm/M_item/item_list.html';
    ...
    if (newPage) {
        ...
        return textContent.includes('품절') || textContent.includes('동일') || textContent.includes('선택');
    }
    return false;
}
