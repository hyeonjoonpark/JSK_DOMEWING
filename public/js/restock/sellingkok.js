...
async function processPageList(page, searchStr) {
    ...
    await page.click('input[name="it_soldout"][value="1"]');
...
async function doRestock(page) {
    ...
    await page.click('body > div:nth-child(2) > div.page-content > form > div:nth-child(11) > div.form-group.pull-left > button:nth-child(3)');
    await delay(3000);
}
