...
<head>
    ...
    <!-- Page Title  -->
    <title>Email Verification | Domewing</title>
    <!-- StyleSheets  -->
            ...
            <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white w-lg-45">
                ...
                <div class="nk-block nk-block-middle nk-auth-body">
                    <div class="brand-logo pb-5">
                        <a href="#" class="">
                            <img class="logo-dark logo-img logo-img-lg" src={{ asset('media/Asset_Logo_Lightbg.svg') }}
                                alt="logo">
                            <img class="logo-light logo-img logo-img-lg" src={{ asset('media/Asset_Logo_Darkbg.svg') }}
                                alt="logo-dark">
                        </a>
                    </div>
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            ...
                            <a href="{{ route('domewing.auth.login') }}" class="btn btn-primary mt-5">Return to login
                                page</a>
                        </div>
                    </div>
                </div><!-- .nk-block -->
            ...
            <div class="nk-split-content nk-split-stretch bg-lighter d-flex toggle-break-lg toggle-slide toggle-slide-right"
                ...
                <div class="slider-wrap w-100 w-max-550px  p-3 p-sm-5 m-auto">
                    <div class="nk-feature nk-feature-center">
                        ...
                        <img class="" src={{ asset('assets\images\loader.gif') }} alt="">

                        <div class="nk-feature-content  py-4 p-sm-5">
                            <h4>Domewing</h4>
                            <p>Start Shopping with Domewing.</p>
                        </div>
                    </div><!-- .nk-feature -->
                </div><!-- .slider-wrap -->
            </div><!-- .nk-split-content -->
