                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">임시 비밀번호를 발급해드렸습니다.</p>
                                    <p style="margin-bottom: 10px;">임시 비밀번호: {{ $tempPassword }}</p>
                                    <a href="{{ url('/') }}/partner/auth/login"
                                        style="background-color:#6576ff;border-radius:4px;color:#ffffff;display:inline-block;font-size:13px;font-weight:600;line-height:44px;text-align:center;text-decoration:none;text-transform: uppercase; padding: 0 30px">로그인
                                        페이지</a>
                                </td>
                            </tr>
                        </tbody>
                            ...
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    ...
                                    <p style="padding-top: 15px; font-size: 12px;">
                                        이 메일은 임시 비밀번호 발급을 위해 셀윙 파트너스로부터 작성되었습니다.
                                    </p>
                                </td>
                            </tr>
                        </tbody>
