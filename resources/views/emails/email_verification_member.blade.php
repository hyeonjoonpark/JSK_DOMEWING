                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding-bottom:25px">
                                    ...
                                    <p style="font-size: 14px; color: #6576ff; padding-top: 12px;">Domewing Member
                                        Registration</p>
                                </td>
                            </tr>
                        </tbody>
                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 15px 30px;">
                                    <h2 style="font-size: 18px; color: #6576ff; font-weight: 600; margin: 0;">Please
                                        Check Your Email Address</h2>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    <p style="margin-bottom: 10px;">Hi, {{ $name }}.</p>
                                    <p style="margin-bottom: 10px;">Welcome! <br> Thank you very much for joining
                                        Domewing.</p>
                                    <p style="margin-bottom: 10px;">Please click the button below to verify your email.
                                    </p>
                                    <a href="{{ url('/') }}/domewing/auth/verify-email?remember_token={{ $remember_token }}"
                            ...
                            <tr>
                                <td style="padding: 0 30px">
                                    <h4
                                        ...
                                        OR</h4>
                                    <p style="margin-bottom: 10px;">Having trouble loading buttons? You can verify your
                                        email through the link below:
                                    </p>
                                    <a href="{{ url('/') }}/domewing/auth/verify-email?remember_token={{ $remember_token }}"
                                        style="color: #6576ff; text-decoration:none;word-break: break-all;">{{ url('/') }}/domewing/auth/verify-email</a>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    ...
                                    <p style="padding-top: 15px; font-size: 12px;">
                                        This email has been sent by Domewing to verify member registration.
                                    </p>
                                </td>
                            </tr>
                        </tbody>
