            ...
            <div class="card card-bordered card-full">
                ...
                <div class="card-inner p-0 border-top">
                    <div class="nk-tb-list nk-tb-orders">
                        ...
                        @foreach ($top6MemberSales as $item)
                            <div class="nk-tb-item">
                                        ...
                                        <li>
                                            <div class="user-avatar">
                                                <img class="w-100 h-100"
                                                    src="https://domewing.com/library/Profile_pictures/{{ $item['member']['profilePicture'] }}" />
                                            </div>
                                        </li>
                                        <li>
                                            <em
                                                class="bg-success-dim icon-circle icon ni ni-arrow-{{ $item['lastMonth'] > $item['thisMonth'] ? 'down' : 'up' }}-left">
                                            </em>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="nk-tb-col">
                                    <span class="tb-sub tb-amount d-flex align-items-top">
                                        이번 달: {{ number_format($item['thisMonth']) }}<img class="ms-1"
                                            src="{{ asset('assets/images/wing.svg') }}" style="width: 1rem;">
                                    </span>
                                    <span class="tb-sub d-flex align-items-top">
                                        지난 달: {{ number_format($item['lastMonth']) }}<img class="ms-1"
                                            src="{{ asset('assets/images/wing.svg') }}" style="width: 1rem;">
                                    </span>
                                    <span class="tb-sub d-flex align-items-top">
                                        Total: {{ number_format($item['total']) }}<img class="ms-1"
                                            src="{{ asset('assets/images/wing.svg') }}" style="width: 1rem;">
                                    </span>
                                </div>
                            </div><!-- .nk-tb-item -->
